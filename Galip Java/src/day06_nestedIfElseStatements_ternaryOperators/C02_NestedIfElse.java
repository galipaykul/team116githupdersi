...
public class C02_NestedIfElse {
    ...
    public static void main(String[] args) {
        ...
        if (cinsiyet == 'K') { // Burada sadece kadınlar var

            // buraya kadınlar için ikinci degişken olan yas'a göre if else oluşturalım
            ...
            // buraya erkekler için ikinci degişken yas'a göre if else oluşturalim
