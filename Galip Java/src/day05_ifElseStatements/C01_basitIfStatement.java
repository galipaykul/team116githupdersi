...
public class C01_basitIfStatement {
    public static void main(String[] args) {
        ...
        if (a+b >100){
            System.out.println("sayıların toplamı 100'den buyuk");
        }
        /*
        ...
        if (c){
            System.out.println("Ozel sart saglandı");
        }

        if (true) {
            System.out.println("Bu yazı her zaman yazdırılır, cunku sart hep true");

        }

        if (false){

            System.out.println("Bu kod hiç calışmaz ");
        }
        }
    }