...
public class C06_EnUzunEnKisaKelime {
    ...
    public static void main(String[] args) {
        ...
        String[] arr = {"Saida","Isa","Asil","Kubra1","Elif","Yusuf"};enUzunVeKisaElemanlar(arr);
    }

        public static void enUzunVeKisaElemanlar(String[] arr) {
        ...
        String enUzunEleman=arr[0];
            ...
            System.out.println("En uzun kelime : " +enKisaEleman);
