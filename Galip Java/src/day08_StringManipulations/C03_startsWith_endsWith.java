...
public class C03_startsWith_endsWith {
    public static void main(String[] args) {
        ...
        /*
        bir yazının (str), bir yazı parçacılığı ile başlayıp
         başlamadığını test ederek, true veya false
        cevabını verir (döndürür)
        */

        String str = "Java cok eğlenceli";
        ...
        System.out.println(str.startsWith("")); // true // herşeyin başında hiçbirsey vardır

        System.out.println("=========================");

        /*
        endsWith() methodu, istenilen bir yazının,
        belli bir yazı parçacığı ile bitip bitmediğini kontrol eder
        */
