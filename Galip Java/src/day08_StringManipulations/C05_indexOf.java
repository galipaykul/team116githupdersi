...
public class C05_indexOf {
    public static void main(String[] args) {
        ...
        /*
        indexOf() methodu aranan yazı parçacığının,
        yazı içerisindeki index'sini bize cevap olarak verir ( dondurur)
        */

        String str = "Java en iyisi en en en";
        ...
        System.out.println(str.indexOf("i",9)); // 9
