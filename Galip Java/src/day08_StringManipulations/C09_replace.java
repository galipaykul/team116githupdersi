...
public class C09_replace {
    public static void main(String[] args) {
        ...
        /*
        bir yazı içerisinde belli başlı harfleri veya
        kelimeleri istediğimiz başka bir unsur değiştirmek için kullanılır
        */
...
//       str = str.replace("va", "lallala"); //Jalallalasiz
//       olmaz // atama ( = ) yaparsak orjinal str değişir.
//        System.out.println(str);

        /*
        atama yapılmadığı sürece yapılan değişiklikler
        sadece o satır için geçerlidir. atama yapılana kadar kalıcı olmaz
        */
