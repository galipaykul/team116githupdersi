...
public class C08_nullPointer {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        String str; // değer tanınmadığı için yazdırma vs işlemleri yapılamıyor

        // System.out.println(str); // CTE // deger atama yapılmadan normalde yazdırma yapılamaz

        /*
        yinede değer ataması yapmadan, boş olarak kalmasını,
        lakin en azından yeri geldiği zaman en azından
